...
import { z } from 'zod';
import { EventType, EventStatus } from '../../../entities/timeline-event.entity';
...
export class CreateTimelineEventDto extends createZodDto(CreateTimelineEventSchema) {}
export class UpdateTimelineEventDto extends createZodDto(UpdateTimelineEventSchema) {}
export class TimelineEventIdDto extends createZodDto(TimelineEventIdSchema) {}
export class ListTimelineEventsDto extends createZodDto(ListTimelineEventsSchema) {}
