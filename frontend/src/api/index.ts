...
export const agentsApi = {
  ...
  get: (id: string) =>
    api.post<Agent>('/agents/action/get', { id }),
  ...
  delete: (id: string) =>
    api.post('/agents/action/delete', { id }),
...
export const rolesApi = {
  ...
  get: (id: string) =>
    api.post<Role>('/roles/action/get', { id }),
  
  create: (data: Partial<Role>) =>
    api.post<Role>('/roles/action/create', data),
  
  update: (id: string, data: Partial<Role>) =>
    api.post<Role>('/roles/action/update', { id, ...data }),
  
  delete: (id: string) =>
    api.post('/roles/action/delete', { id }),
};

// Capabilities API
export const capabilitiesApi = {
  list: (params: { page?: number; limit?: number; search?: string }) =>
    api.post<{ items: Capability[]; total: number }>('/capabilities/action/list', params),
  
  get: (id: string) =>
    api.post<Capability>('/capabilities/action/get', { id }),
  ...
  delete: (id: string) =>
    api.post('/capabilities/action/delete', { id }),
};

// Timeline API
export const timelineApi = {
  list: (params: { page?: number; limit?: number; search?: string; isEnabled?: boolean }) =>
    api.post<{ items: TimelineNotifier[]; total: number }>('/timeline/action/list', params),
  ...
  delete: (id: string) =>
    api.post('/timeline/action/delete', { id }),
  
  trigger: (id: string) =>
    api.post('/timeline/action/trigger', { id }),
};
